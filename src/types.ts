/**
 * Core types for @cartisien/engram v1.1
 *
...
// ────────────────────────────────────────────────────────────────────────────
// Original adapter-based types (used by src/engram.ts and src/adapters/)
// ────────────────────────────────────────────────────────────────────────────
...
export interface AdapterEngramConfig {
  adapter: AdapterType
  agentId: string
...
// ────────────────────────────────────────────────────────────────────────────
// v0.7+ Session-based types (used by src/index.ts, src/search/, src/graph/)
// ────────────────────────────────────────────────────────────────────────────
...
/**
 * Configuration for Engram instance - v1.1 extended
 */
